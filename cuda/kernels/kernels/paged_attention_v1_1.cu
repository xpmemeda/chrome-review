...
template <typename scalar_t, int HEAD_SIZE, int BLOCK_SIZE,
    int NUM_THREADS>
__global__ void single_query_cached_kv_attention_kernel_1(  //
...
void single_query_cached_kv_attention_launcher(  //
  ...
  switch (head_size) {
    case 64: {
      ...
      cudaFuncSetAttribute(vllm::single_query_cached_kv_attention_kernel_1<T, HEAD_SIZE, BLOCK_SIZE, NUM_THREADS>,
          cudaFuncAttributeMaxDynamicSharedMemorySize, shared_mem_size);
      vllm::single_query_cached_kv_attention_kernel_1<T, HEAD_SIZE, BLOCK_SIZE, NUM_THREADS>
...
static Register _(
    [](pybind11::module& m) { m.def("paged_attention_v1_1", &decode_attn_1, "Layout_K.VLLM; Layout_V.VLLM"); });
