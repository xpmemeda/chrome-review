...
__global__ void single_query_cached_kv_attention_kernel_6(  //
  ...
  // // A10 0.155
  // using LoadQAndGemmQk = LoadQAndGemmQk_CR2<scalar_t, HEAD_SIZE, BLOCK_SIZE, NUM_THREADS>;
  // // A10 0.148
  // using LoadQAndGemmQk = LoadQAndGemmQk_CR3<scalar_t, HEAD_SIZE, BLOCK_SIZE, NUM_THREADS>;
  ...
  // // A10 0.139
  // using GemmPvAndStoreO = GemmPvAndStoreO_CR2<scalar_t, HEAD_SIZE, BLOCK_SIZE, NUM_THREADS>;
  // // A10 0.132
  // using GemmPvAndStoreO = GemmPvAndStoreO_CR3<scalar_t, HEAD_SIZE, BLOCK_SIZE, NUM_THREADS>;
...
void single_query_cached_kv_attention_launcher(  //
  ...
  auto kernel = &single_query_cached_kv_attention_kernel_6<T, HEAD_SIZE, BLOCK_SIZE, NUM_THREADS>;
...
static cr::Register _(
    [](pybind11::module& m) { m.def("paged_attention_v1_8", &decode_attn_6, "Layout_K.CR; Layout_V.CR"); });
