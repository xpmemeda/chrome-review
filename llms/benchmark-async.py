...
async def main(args):
    ...
    backend = backend_cls(args.model, args.model)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num-prompts", "--n", type=int, help="128", required=True)
    parser.add_argument("--num-coroutine", "--b", type=int, help="8", required=True)

    parser.add_argument("--num-prompt-tokens", "--i", type=int)
    parser.add_argument("--num-prompt-hit-tokens", "--h", type=int)
    parser.add_argument("--num-output-tokens", "--o", type=int)
    parser.add_argument("--data-file-path", "--f", type=str)
