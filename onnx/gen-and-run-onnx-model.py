...
reshape_i1 = onnx.helper.make_node("Reshape", ["i", "add_a_b:0"], ["reshape_i1:0"], "reshape_i1")
reshape_i2 = onnx.helper.make_node("Reshape", ["reshape_i1:0", "c"], ["o"], "reshape_i2")

graph = onnx.helper.make_graph([add_a_b, reshape_i1, reshape_i2], "graph", [i, a, b, c], [o], initializer=[value_c])
...
o = onnxnet.run(None, {"i": np.array([[3, 2, 1, 0]], np.float32), "a": np.array([1, 1], np.int64), "b": np.array([1, 1], np.int64)})[0]
print(o)
